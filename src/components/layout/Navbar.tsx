        ...
        <div className="container mx-auto px-6 md:px-12 flex items-center justify-between h-full">
          ...
          <div className="flex items-center gap-6 h-full">
            ...
            >
              {sidebarOpen ? (
                ...
                <Menu className="w-8 h-8 transition-colors text-white" strokeWidth={1.5} />
              )}
            </button>
            
            <Link href="/" className="flex items-center gap-2 group relative z-50">
              <svg width="32" height="32" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="50" cy="50" r="48" stroke="currentColor" strokeWidth="2" className="text-white" />
                <path d="M40 70 L50 30 L60 70" stroke="currentColor" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" className="text-white" />
                <path d="M43 60 L57 60" stroke="currentColor" strokeWidth="8" strokeLinecap="round" className="text-white" />
              </svg>
          ...
          <div className="flex items-center gap-6 relative z-50">
            <Link
              href="/#contact"
              className={cn(
                "transition-all px-6 py-2.5 text-[13px] font-bold uppercase tracking-wider hidden md:inline-flex",
      ...
      <AnimatePresence>
        {sidebarOpen && (
          <motion.div
            ...
            className="fixed inset-0 bg-[#0A0A0A] text-white z-40 overflow-y-auto pt-[100px] flex flex-col justify-between"
          >
            <div className="container mx-auto px-6 py-12 flex flex-col h-full">
                    ...
                    {sidebarLinks.map((link, idx) => (
                      ...
                      >
                        <Link
                          ...
                          className="text-[48px] md:text-[64px] font-bold hover:text-brand-primary transition-colors leading-[1.1] tracking-tight hover:pl-4 inline-block duration-300 relative group"
                        >
                          {link.name}
                        </Link>
                      </motion.div>
              ...
              <motion.div 
                ...
                className="pt-8 border-t border-white/10 flex flex-col justify-between items-start gap-8 mt-12"
              >
