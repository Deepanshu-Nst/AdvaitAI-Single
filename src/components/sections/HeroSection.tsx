...
export default function HeroSection() {
  return (
    <section className="relative w-full min-h-[100svh] bg-[#F0F7FF] overflow-hidden flex items-center pt-24 md:pt-28">
      {/* Background */}
      <div
        ...
        style={{
          ...
          `,
          backgroundSize: typeof window !== 'undefined' && window.innerWidth < 768 ? "cover" : "115% auto",
          backgroundPosition: typeof window !== 'undefined' && window.innerWidth < 768 ? "center" : "right center",
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-20 w-full">
        <div className="max-w-[1000px] w-full text-center md:text-left -mt-8 md:-mt-16">
          <motion.div
          ...
          >
            <h1 className="text-[32px] sm:text-[40px] md:text-[52px] lg:text-[60px] font-bold tracking-tight leading-[1.1] text-[#0C2D57] drop-shadow-sm mb-4">
          ...
          <motion.p
            ...
            className="text-[16px] md:text-[24px] font-light text-[#3B5B8A] max-w-[700px] mx-auto md:mx-0 leading-[1.6]"
          >
